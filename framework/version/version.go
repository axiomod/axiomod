...
// Usage: go build -ldflags "-X axiomod/framework/version.Version=1.0.0 -X axiomod/framework/version.GitCommit=$(git rev-parse HEAD) -X axiomod/framework/version.BuildDate=$(date -u +'%Y-%m-%dT%H:%M:%SZ')"
