...
func NewViperProvider(configPath string, configName string, configType string) (*ViperProvider, error) {
	 ...
	 if configPath != "" {
		 ...
		 v.AddConfigPath("internal/framework/config")        // ./internal/framework/config
		 v.AddConfigPath("../internal/framework/config")     // ../internal/framework/config
		 v.AddConfigPath("../../internal/framework/config")  // ../../internal/framework/config (often works for tests in cmd/*)
...
func LoadCLIConfig() (Provider, error) {
	 ...
	 paths := []string{
		 ...
		 "./config",
		 ".",
		 "../internal/framework/config", // Added for robustness
		 "../../internal/framework/config", // Added for robustness
	 }
