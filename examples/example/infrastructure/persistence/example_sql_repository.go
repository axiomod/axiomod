...
// ExampleSQLRepository implements the ExampleRepository interface with plain
// database/sql queries. It is selected when database.orm is set to "sql";
// the default is the Ent implementation in example_ent_repository.go.
type ExampleSQLRepository struct {
	db     *sql.DB
	logger *observability.Logger
}

// NewExampleSQLRepository creates a new ExampleSQLRepository
func NewExampleSQLRepository(db *sql.DB, logger *observability.Logger) *ExampleSQLRepository {
...
func (r *ExampleSQLRepository) Create(ctx context.Context, example *entity.Example) error {
	// Plain database/sql implementation: create the entity
...
func (r *ExampleSQLRepository) GetByID(ctx context.Context, id string) (*entity.Example, error) {
	// Plain database/sql implementation: retrieve the entity
	// For this example, we'll use a simple SQL query
	query := `
...
func (r *ExampleSQLRepository) Update(ctx context.Context, example *entity.Example) error {
	// Plain database/sql implementation: update the entity
	// For this example, we'll use a simple SQL query
	query := `
		UPDATE examples
...
func (r *ExampleSQLRepository) Delete(ctx context.Context, id string) error {
	// Plain database/sql implementation: delete the entity
	// For this example, we'll use a simple SQL query
...
func (r *ExampleSQLRepository) List(ctx context.Context, filter repository.ExampleFilter) ([]*entity.Example, error) {
	// Plain database/sql implementation: query the entities
	// For this example, we'll use a simple SQL query
	query := `
		SELECT id, name, description, value_type, value_count, created_at, updated_at
		FROM examples
